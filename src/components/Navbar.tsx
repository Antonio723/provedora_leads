      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <a
              href={`https://wa.me/${WA_NUMBER}?text=Ol%C3%A1%2C+gostaria+de+contratar+um+plano+de+internet!`}
              target="_blank"
              rel="noopener noreferrer"
              className="bg-whatsapp hover:bg-whatsapp-dark text-white text-sm font-semibold px-4 py-2 rounded-full transition-colors flex items-center gap-1.5"
            >
          ...
          <div className="lg:hidden bg-white border-t border-slate-100 py-4">
            <ul className="flex flex-col gap-1">
              {navLinks.map((l) => (
                <li key={l.href}>
                  <button
                    onClick={() => handleNav(l.href)}
                    className="w-full text-left px-4 py-3 text-slate-700 font-medium hover:bg-slate-50 rounded-lg"
                  >
                    {l.label}
                  </button>
                </li>
            ...
            <div className="mt-4 px-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 w-full bg-whatsapp text-white font-semibold py-3 rounded-full"
              >
